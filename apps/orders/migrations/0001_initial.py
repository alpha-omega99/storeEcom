...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0009_product_embroidery_required'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.CharField(db_index=True, default=apps.orders.models.generate_order_reference, max_length=20, unique=True)),
