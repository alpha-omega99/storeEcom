...
urlpatterns = [
    ...
    # ===== PERSONNALISATION =====
    path('personnaliser/', views.personalize_view, name='personalize'),  # Correction: name='personalize'
    ...
    # ===== COMMANDE =====
    path('commande/<str:reference>/', views.order_detail_view, name='order_detail'), 
